...
class IdIsoSFStopFiller(TreeCloner):
    ...
    def checkOptions(self,opts):
        ...
        elif opts.cmssw == "Rereco2016" : # Just a copy of ICHEP for the time being
    ...
    def _getWeight (self, kindLep, pt, eta, tight, ScaleFactorLevel, nvtx):
        ...
        # Reco scale factor
            ...
            if kindLep == 'ele' :
                ...
                relative_error_lowpt = 0.
                if pt < 20 :
                    relative_error_lowpt = 0.03
                    pt = 20
                ...
                relative_error_scaleFactor = math.sqrt( (RecoSFErr/RecoSF)*(RecoSFErr/RecoSF) + relative_error_lowpt*relative_error_lowpt + relative_error_pu*relative_error_pu )
                scaleFactor_do = scaleFactor*(1. -  relative_error_scaleFactor)
                scaleFactor_up = scaleFactor*(1. +  relative_error_scaleFactor)
